...
public class OssController {
    ...
    String accessId = "LTAI5tP1yqqa7cB1GNJmq7EF"; // 请填写您的AccessKeyId。
    String accessKey = "RizUX6Zakgm7fZ4YS8jwJHHwdHXDI7"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "wanghang-mall"; // 请填写您的 bucketname 。
